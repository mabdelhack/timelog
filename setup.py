...
setup(
  name = 'timelogging',         # How you named your package folder (MyLib)
  long_description = long_description,
  long_description_content_type = "text/markdown",
  packages = ['timelog'],   # Chose the same as "name"
  package_dir={'timelogging': 'timelogging'},
  ...
  url = 'https://github.com/mabdelhack/timelogging',   # Provide either the link to the package's github or website
